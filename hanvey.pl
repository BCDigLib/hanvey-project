...
########
	...
	my %subj_names=(
		...
		faulkner=>	'<mods:name type="personal"><mods:namePart type="family">Faulkner</mods:namePart><mods:namePart type="given">Lucy</mods:namePart><mods:namePart type="termsOfAdress">Lady</mods:namePart><mods:displayForm>Faulkner, Lucy, Lady</mods:displayForm></mods:name>',
